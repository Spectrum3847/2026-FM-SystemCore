...
public class RollerConfig {
    ...
    @Getter private Color8Bit offColor = new Color8Bit(Color.BLACK);

    /** Color displayed when the roller is spinning in the forward direction. */
    @Getter private Color8Bit fwdColor = new Color8Bit(Color.GREEN);

    /** Color displayed when the roller is spinning in the reverse direction. */
    @Getter private Color8Bit revColor = new Color8Bit(Color.RED);
