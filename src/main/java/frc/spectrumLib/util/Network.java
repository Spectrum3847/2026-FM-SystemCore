    ...
    public static String getMACaddress() {
        ...
        for (int i = 0; i < 10; i++) {
            try {
                ...
                DriverStationErrors.reportWarning("Failed to get MAC, retrying", null);
            }
        }

        DriverStationErrors.reportWarning("Failed to get MAC", null);
        return unknown;
    }
    ...
    public static String getIPaddress() {
        ...
        for (int i = 0; i < 10; i++) {
            try {
                ...
                DriverStationErrors.reportWarning("Failed to get IP, retrying", null);
            }
        }

        DriverStationErrors.reportWarning("Failed to get IP", null);
        return unknown;
    }
